var c=1;
			var row, userID, firstName, lastName, emailID, password, deleteBtn, pwdDB, mobileNumber;
            function addUser(){
				var table = document.getElementById("userTable");
                console.log(c);
                if(document.getElementById("EmpFirstName").value == null || document.getElementById("EmpFirstName").value == "" || document.getElementById("EmpLastName").value == null || document.getElementById("EmpLastName").value == "" || document.getElementById("EmpEmailID").value == null || document.getElementById("EmpEmailID").value == "" || document.getElementById("EmpPassword").value == null || document.getElementById("EmpPassword").value == "" || document.getElementById("EmpMobileNum").value == "" || document.getElementById("EmpMobileNum").value == null) {
                ...
                var firstName = row.insertCell(1);
  				...
  				var mobileNumber = row.insertCell(4);
				...
				mobileNumber.innerHTML = document.getElementById("EmpMobileNum").value;
                ...
                document.getElementById("EmpMobileNum").value = "";
